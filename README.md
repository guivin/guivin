...
- 🔭 I'm currently working at [Datadome](https://datadome.co) as a **Site Reliability Engineer**, on high-scale infrastructure for intent-based fraud detection.
- 🌱 I'm currently learning how **agentic AI** can augment SRE workflows — anomaly detection, toil identification, trends and smarter alerting across the observability stack.
